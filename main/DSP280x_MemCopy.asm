...
;* Date/Time created: Mon Jan 16 11:31:22 2023                 *
;***************************************************************
...
;	..\Compiler\bin\opt2000.exe C:\Users\JS\AppData\Local\Temp\TI12010 C:\Users\JS\AppData\Local\Temp\TI1204 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\JS\AppData\Local\Temp\TI1202 --template_info_file C:\Users\JS\AppData\Local\Temp\TI1206 --object_file DSP280x_MemCopy.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
	.global	_MemCopy
...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("H:\Tracer_Mouse\Tracer\STEP\Vulture\main\DSP280x_MemCopy.asm:L1:1:1673836282")
