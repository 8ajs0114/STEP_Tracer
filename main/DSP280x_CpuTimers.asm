...
;	..\Compiler\bin\opt2000.exe C:\Users\JS\AppData\Local\Temp\TI06810 C:\Users\JS\AppData\Local\Temp\TI0684 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\JS\AppData\Local\Temp\TI0682 --template_info_file C:\Users\JS\AppData\Local\Temp\TI0686 --object_file DSP280x_CpuTimers.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
...
DW$18	.dwtag  DW_TAG_subprogram, DW_AT_name("Init_ISR"), DW_AT_symbol_name("_Init_ISR")
	...
	.dwattr DW$18, DW_AT_begin_line(0x78)
	.dwattr DW$18, DW_AT_begin_column(0x06)
	.dwpsn	"DSP280x_CpuTimers.c",121,1
...
;*** 123	-----------------------    asm(" setc INTM");
;*** 125	-----------------------    asm(" EALLOW");
;*** 128	-----------------------    PieVectTable.TINT0 = &Sensor_Value;
;*** 129	-----------------------    PieVectTable.ADCINT = &ADC_TIMER_ISR;
;*** 131	-----------------------    asm(" EDIS");
;*** 133	-----------------------    IER |= 0x3001u;
;*** 135	-----------------------    *(&PieCtrlRegs+2L) |= 0x40u;
;*** 136	-----------------------    *(&PieCtrlRegs+2L) |= 0x20u;
;*** 138	-----------------------    ConfigCpuTimer(&CpuTimer0, 100.0F, 25.0F);
;*** 141	-----------------------    asm(" clrc INTM");
;*** 142	-----------------------    asm(" clrc DBGM");
;*** 142	-----------------------    return;
	.dwcfa	0x1d, -2
 ...
 EALLOW
	.dwpsn	"DSP280x_CpuTimers.c",128,3
        MOVL      XAR4,#_Sensor_Value   ; |128| 
        MOVW      DP,#_PieVectTable+76
        MOVL      @_PieVectTable+76,XAR4 ; |128| 
	.dwpsn	"DSP280x_CpuTimers.c",129,2
        MOVL      XAR4,#_ADC_TIMER_ISR  ; |129| 
